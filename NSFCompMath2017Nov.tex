...
\subsubsection{Publications and Conference Participation} This project has resulted in a 
number of publications by the PI, GEF, students, and collaborators (see the list at the beginning of 
this 
section).  We have also spoken at a number of applied mathematics, statistics, and computational 
science conferences.  As highlights, the PI gave invited tutorials at the Twelfth International 
Conference 
on Monte Carlo and Quasi-Monte Carlo Methods in Scientific Computing (MCQMC 2016) 
\cite{Hic17a} and at the Opening Worskshop of SAMSI-QM.

\subsubsection{title}

\subsubsection{Boosting the STEM Workforce}
