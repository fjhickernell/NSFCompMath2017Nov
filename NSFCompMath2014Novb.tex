...
\newcommand{\refprobdc}{\hyperref[Sec_TruncHS]{Research Project~4.3}\xspace}
\newcommand{\refprobdd}{\hyperref[ebolasubsec]{Research Project~4.4}\xspace}
...
\end{equation}
\end{subequations}
For practical applications the matrices $\mLambda_2$ and $\mPhi_2$ will therefore have to be truncated appropriately \citep{CavorettoEtAl14,FMcC12}. %(see Sect. \refprobdc).
