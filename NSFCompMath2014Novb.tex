...
Furthermore, we want to work in a setting where adaptive algorithms show a significant advantage over non-adaptive algorithms.  It has been known for a long time that this typically cannot happen for balls of input functions because balls are a convex set \cite[Chapter 4, Theorem 5.2.1]{TraWasWoz88}.  Because cones need not be convex (think of a hollow ice cream cone), adaptive algorithms may be advantageous for cones of input functions.
